...
const AddNewPetRecordForm = ({ ID }) => {
  ...
  //   try {
  //     const response = await fetch(`http://localhost:4000/api/v1/pet-record`, {
  //       method: "POST",
  //       body: formData
  //     });
  ...
  useEffect(() => {
    fetch("http://localhost:4000/api/v1/pet/?POID="+localStorage.getItem("UserTypeID"))
  ...
  const handleFormSubmit = e => {
    ...
    fetch("http://localhost:4000/api/v1/pet-record", {
      method: "POST",
      headers: {
