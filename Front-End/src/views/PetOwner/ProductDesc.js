...
class PetStoreItems extends React.Component {
  ...
  componentDidMount() {
    fetch('http://localhost:4000/api/v1/product/'+this.params.get("productID"))
  ...
  AddtoCart(){
    ...
    fetch('https://api-trs.azurewebsites.net/api/Reservation', {
      method: 'POST',
      headers: {
                          ...
                          <div className="row">
                              ...
                              <main className="col-md-6">
                                  <article>
                                      ...
                                      <div className="mb-3">
                                          <p className="text-dark" style={{ fontSize: 40 }}>Rs {totalAmount}</p>
                                          <span className="monthly" style={{ fontSize: 18 }}>Rs {PostsListOne.Price} / piece <a href="#" className="btn-link"></a></span>
                                      </div> 
