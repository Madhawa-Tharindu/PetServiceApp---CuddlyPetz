...
class StoreOrdersUser extends React.Component {
  ...
  componentDidMount() {
    fetch(
      "http://localhost:4000/api/v1/order/?POID=" +
                        ...
                        <td>
                          <Row form>
                            <Col md="12" className="mb-3">
                              ...
                              ) : post.OrderStatus === "Rejected" ? (
                                <Button theme="danger">Rejected</Button>
                              ) : (
                                <Button theme="primary">Delivered</Button>
                              )}
                            </Col>
                          </Row>
                        </td>
